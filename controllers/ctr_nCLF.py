...
class Ctr_nCLF(Controller):
    ...
    def __init__(self,
                 ...
                 model_path:str = 'controllers/trainedNetworks/InvertedPendulum/epoch100.pth',
        ...
        self.clfqp = self.makeproblem_clfqp()
    ...
    def u(self,x:ndarray,t:Optional[float]=None) -> ndarray:
        ...
        self.clfqp.solve(solver=cp.ECOS)
    ...
    def makeproblem_clfqp(self) -> cp.Problem:
        '''
        sets up the CLFQP
        '''
